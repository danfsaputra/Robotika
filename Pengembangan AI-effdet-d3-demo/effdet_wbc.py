...
MODEL_LOCAL_PATH = os.path.join(MODEL_CACHE_DIR, "efficientdet_d3")
...
while True:
    ...
    if frame_skip_enabled and skip_frames > 0 and frame_count % (skip_frames + 1) != 0:
        ...
        if last_annotated_frame is not None:
            ...
            cv2.imshow("EfficientDet-D3 Webcam (CPU)", display_frame)
    ...
    # Display
    cv2.imshow("EfficientDet-D3 Webcam (CPU)", annotated_frame)
